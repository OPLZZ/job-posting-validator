...
* If you don't have {Fuseki server}[http://jena.apache.org/documentation/serving_data/index.html] installed, you can install it by running <tt>bundle exec rake validator:fuseki:install</tt>.
